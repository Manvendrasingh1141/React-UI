function Card4(){
    ...
    <div className="h-130 w-55 rounded-3xl relative">
        <div className="absolute rounded-full w-7 h-7 m-3 bg-white flex justify-center font-medium">4</div>
        ...
        <img src="./public/formal04.jpg" alt="" className="w-full h-full object-cover rounded-3xl z-0"/>
